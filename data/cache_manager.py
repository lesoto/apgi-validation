    ...
    def set(self, key: Any, value: Any, ttl: Optional[int] = None):
        ...
        with self._lock:
            ...
            try:
                ...
                print(f"Error saving cache entry {cache_key}: {e}")
...
class DataCache:
    ...
    def cache_preprocessed_data(self, file_path: Union[str, Path], 
    ...
    def get_preprocessed_data(self, file_path: Union[str, Path], 
                            preprocessing_config: Dict) -> Optional[pd.DataFrame]:
    ...
    def cache_simulation_results(self, model_params: Dict, 
    ...
    def get_simulation_results(self, model_params: Dict, 
                             simulation_config: Dict) -> Optional[Dict]:
    ...
    def cache_validation_results(self, protocol_name: str,
    ...
    def get_validation_results(self, protocol_name: str,
                              validation_config: Dict) -> Optional[Dict]:
