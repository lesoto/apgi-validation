...
class DataValidator:
    ...
    def _validate_csv_structure(self, df: pd.DataFrame, results: Dict) -> bool:
        ...
        optional_columns = ['eeg_pz', 'heart_rate', 'event_marker', 'subject_id', 'session_id']
...
class DataPreprocessor:
    ...
    def filter_signals(self, df: pd.DataFrame, filter_type: str = 'bandpass', 
                      columns: List[str] = None, **filter_params) -> pd.DataFrame:
    ...
    def normalize_data(self, df: pd.DataFrame, method: str = 'zscore', 
    ...
    def resample_data(self, df: pd.DataFrame, target_rate: float, 
