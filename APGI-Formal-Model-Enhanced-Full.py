...
class PsychologicalState:
    ...
    def to_dynamical_inputs(self, time: float = 0.0, 
                           include_expectation: bool = False) -> Dict[str, float]:
...
class StateCategory(Enum):
    ...
    COGNITIVE_ATTENTIONAL = ("#FF9F1C", "Cognitive/Attentional", "Information processing")
    ...
    TRANSITIONAL_CONTEXTUAL = ("#06D6A0", "Transitional/Contextual", "Context-dependent")
...
class APGIStateLibrary:
    ...
    def _initialize_all_states(self):
        ...
        self._add_state(
            ...
            Pi_e_actual=6.5, Pi_i_baseline_actual=1.5, M_ca=0.3, beta=1.0,
            z_e=0.4, z_i=0.2, theta_t=1.8,
            Pi_e_expected=6.5, Pi_i_expected=1.5,  # Π̂ = Π
            arousal_level=0.7, content_domain="neutral"
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=8.0, Pi_i_baseline_actual=1.2, M_ca=0.25, beta=1.2,
            z_e=0.8, z_i=0.3, theta_t=-0.5,
            Pi_e_expected=8.0, Pi_i_expected=1.2,
            arousal_level=0.8
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=1.5, Pi_i_baseline_actual=2.0, M_ca=0.7, beta=0.8,
            z_e=0.2, z_i=0.3, theta_t=1.5,
            Pi_e_expected=1.5, Pi_i_expected=2.0,
            arousal_level=0.3
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=3.0, Pi_i_baseline_actual=3.5, M_ca=0.9, beta=1.0,
            z_e=0.6, z_i=0.5, theta_t=0.0,
            Pi_e_expected=3.0, Pi_i_expected=3.5,
            arousal_level=0.5
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=4.0, Pi_i_baseline_actual=1.0, M_ca=-0.1, beta=0.8,
            z_e=1.2, z_i=0.2, theta_t=-0.3,
            Pi_e_expected=4.0, Pi_i_expected=1.0,
            arousal_level=0.6
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=5.0, Pi_i_baseline_actual=2.5, M_ca=0.8, beta=1.1,
            z_e=1.0, z_i=0.7, theta_t=-0.8,
            Pi_e_expected=5.0, Pi_i_expected=2.5,
            arousal_level=0.9
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=4.5, Pi_i_baseline_actual=3.0, M_ca=1.1, beta=1.3,
            z_e=1.2, z_i=0.9, theta_t=-0.6,
            Pi_e_expected=4.5, Pi_i_expected=3.0,
            arousal_level=0.7
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=7.5, Pi_i_baseline_actual=4.0, M_ca=1.8, beta=1.8,
            z_e=1.5, z_i=1.3, theta_t=-1.5,
            Pi_e_expected=7.5, Pi_i_expected=4.0,
            arousal_level=0.95
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=5.0, Pi_i_baseline_actual=3.0, M_ca=1.2, beta=1.3,
            z_e=0.5, z_i=0.6, theta_t=-0.8,
            Pi_e_expected=5.0, Pi_i_expected=3.0,
            arousal_level=0.6
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=4.0, Pi_i_baseline_actual=2.5, M_ca=0.8, beta=1.1,
            z_e=0.3, z_i=0.5, theta_t=-0.4,
            Pi_e_expected=4.0, Pi_i_expected=2.5,
            arousal_level=0.6
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=5.0, Pi_i_baseline_actual=2.0, M_ca=0.6, beta=0.9,
            z_e=0.9, z_i=0.4, theta_t=-0.7,
            Pi_e_expected=5.0, Pi_i_expected=2.0,
            arousal_level=0.7
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=3.0, Pi_i_baseline_actual=2.0, M_ca=0.4, beta=0.8,
            z_e=0.4, z_i=0.3, theta_t=-0.5,
            Pi_e_expected=3.0, Pi_i_expected=2.0,
            arousal_level=0.5
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=6.0, Pi_i_baseline_actual=1.0, M_ca=-0.2, beta=0.7,
            z_e=1.4, z_i=0.2, theta_t=-0.9,
            Pi_e_expected=6.0, Pi_i_expected=1.0,
            arousal_level=0.7
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=0.8, Pi_i_baseline_actual=1.5, M_ca=-0.3, beta=0.8,
            z_e=0.1, z_i=0.2, theta_t=-1.0,
            Pi_e_expected=0.8, Pi_i_expected=1.5,
            arousal_level=0.2
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=4.0, Pi_i_baseline_actual=1.0, M_ca=-0.3, beta=0.7,
        ...
        self._add_state(
            ...
            Pi_e_actual=8.5, Pi_i_baseline_actual=1.5, M_ca=0.4, beta=0.9,
            z_e=2.0, z_i=0.4, theta_t=-2.0,
            Pi_e_expected=8.5, Pi_i_expected=1.5,
            arousal_level=0.8
        )
        ...
        self._add_state(
            ...
            phenomenology=["tunnel vision", "time distortion", "exclusion of distractions"],
            Pi_e_actual=9.5, Pi_i_baseline_actual=0.5, M_ca=-0.8, beta=0.6,
            z_e=0.6, z_i=0.1, theta_t=2.5,
            Pi_e_expected=9.5, Pi_i_expected=0.5,
            arousal_level=0.9
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=1.5, Pi_i_baseline_actual=2.0, M_ca=0.4, beta=0.8,
            z_e=0.3, z_i=0.4, theta_t=1.8,
            Pi_e_expected=1.5, Pi_i_expected=2.0,
            arousal_level=0.2
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=2.5, Pi_i_baseline_actual=1.5, M_ca=0.3, beta=0.8,
            z_e=0.8, z_i=0.3, theta_t=1.5,
            Pi_e_expected=2.5, Pi_i_expected=1.5,
            arousal_level=0.3
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=0.8, Pi_i_baseline_actual=3.5, M_ca=0.6, beta=1.1,
            z_e=0.2, z_i=0.9, theta_t=1.5,
            Pi_e_expected=0.8, Pi_i_expected=3.5,
            arousal_level=0.4
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=8.0, Pi_i_baseline_actual=3.0, M_ca=1.9, beta=1.9,
            z_e=2.5, z_i=2.0, theta_t=-2.5,
            Pi_e_expected=9.0, Pi_i_expected=3.5,  # Π̂ > Π for threat vigilance
            arousal_level=0.95, content_domain="survival", GAD_profile=True
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=6.5, Pi_i_baseline_actual=3.5, M_ca=1.5, beta=1.6,
            z_e=1.5, z_i=1.3, theta_t=-1.5,
            Pi_e_expected=8.0, Pi_i_expected=4.5,  # LARGE Π̂ > Π gap
            arousal_level=0.8, GAD_profile=True
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=7.5, Pi_i_baseline_actual=3.0, M_ca=1.5, beta=1.6,
            z_e=2.0, z_i=1.4, theta_t=-1.2,
            Pi_e_expected=7.5, Pi_i_expected=3.0,
            arousal_level=0.9, content_domain="survival"
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=5.0, Pi_i_baseline_actual=2.5, M_ca=0.8, beta=1.1,
            z_e=1.3, z_i=0.9, theta_t=-0.8,
            Pi_e_expected=5.0, Pi_i_expected=2.5,
            arousal_level=0.6, MDD_profile=True
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=7.0, Pi_i_baseline_actual=3.0, M_ca=1.3, beta=1.3,
            z_e=1.8, z_i=1.2, theta_t=-1.5,
            Pi_e_expected=7.0, Pi_i_expected=3.0,
            arousal_level=0.7, MDD_profile=True
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=5.5, Pi_i_baseline_actual=2.5, M_ca=0.8, beta=1.1,
            z_e=1.4, z_i=0.9, theta_t=-1.0,
            Pi_e_expected=5.5, Pi_i_expected=2.5,
            arousal_level=0.5, MDD_profile=True
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=3.0, Pi_i_baseline_actual=3.0, M_ca=1.2, beta=1.3,
            z_e=2.8, z_i=1.5, theta_t=0.0,
            Pi_e_expected=3.0, Pi_i_expected=3.0,
            arousal_level=0.85, GAD_profile=True
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=2.0, Pi_i_baseline_actual=1.5, M_ca=0.3, beta=0.8,
            z_e=0.4, z_i=0.8, theta_t=1.5,
            Pi_e_expected=2.0, Pi_i_expected=1.5,
            arousal_level=0.2, MDD_profile=True
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=1.5, Pi_i_baseline_actual=2.0, M_ca=0.5, beta=0.8,
            z_e=0.2, z_i=0.4, theta_t=2.0,
            Pi_e_expected=1.5, Pi_i_expected=2.0,
            arousal_level=0.3, MDD_profile=True
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=2.5, Pi_i_baseline_actual=2.0, M_ca=0.7, beta=1.1,
            z_e=0.3, z_i=0.6, theta_t=1.8,
            Pi_e_expected=2.5, Pi_i_expected=2.0,
            arousal_level=0.3, MDD_profile=True
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=4.0, Pi_i_baseline_actual=5.0, M_ca=2.0, beta=2.2,
            z_e=1.5, z_i=3.0, theta_t=-3.0,
            Pi_e_expected=5.0, Pi_i_expected=6.0,  # Large expectation gap
            arousal_level=0.99, content_domain="survival", GAD_profile=True
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=2.0, Pi_i_baseline_actual=0.5, M_ca=-1.5, beta=0.5,
            z_e=0.8, z_i=0.1, theta_t=2.0,
            Pi_e_expected=2.0, Pi_i_expected=0.5,
            arousal_level=0.1, psychosis_profile=True
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=3.0, Pi_i_baseline_actual=0.8, M_ca=-1.2, beta=0.6,
            z_e=1.0, z_i=0.5, theta_t=1.5,
            Pi_e_expected=3.0, Pi_i_expected=0.8,
            arousal_level=0.2, psychosis_profile=True
        )
        ...
        self._add_state(
            ...
            phenomenology=["world-unreality", "dreamlike state", "perceptual distortion"],
            Pi_e_actual=1.5, Pi_i_baseline_actual=1.5, M_ca=-0.8, beta=0.7,
            z_e=1.2, z_i=0.4, theta_t=1.8,
            Pi_e_expected=1.5, Pi_i_expected=1.5,
            arousal_level=0.3, psychosis_profile=True
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=3.5, Pi_i_baseline_actual=2.5, M_ca=0.8, beta=1.1,
            z_e=2.8, z_i=0.7, theta_t=-1.5,
            Pi_e_expected=3.5, Pi_i_expected=2.5,
            arousal_level=0.8
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=1.0, Pi_i_baseline_actual=4.0, M_ca=0.4, beta=0.8,
            z_e=0.2, z_i=0.6, theta_t=2.0,
            Pi_e_expected=1.0, Pi_i_expected=4.0,
            arousal_level=0.3
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=2.5, Pi_i_baseline_actual=5.0, M_ca=1.5, beta=0.9,
            z_e=1.0, z_i=1.2, theta_t=-1.0,
            Pi_e_expected=2.5, Pi_i_expected=5.0,
            arousal_level=0.4
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=1.5, Pi_i_baseline_actual=2.0, M_ca=-0.5, beta=0.6,
            z_e=0.8, z_i=0.4, theta_t=1.0,
            Pi_e_expected=1.5, Pi_i_expected=2.0,
            arousal_level=0.3, psychosis_profile=True
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=6.0, Pi_i_baseline_actual=3.0, M_ca=1.2, beta=1.4,
            z_e=1.8, z_i=0.9, theta_t=-1.8,
            Pi_e_expected=6.0, Pi_i_expected=3.0,
            arousal_level=0.9
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=3.0, Pi_i_baseline_actual=2.5, M_ca=0.6, beta=1.0,
            z_e=0.5, z_i=0.6, theta_t=-0.3,
            Pi_e_expected=3.0, Pi_i_expected=2.5,
            arousal_level=0.5
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=2.5, Pi_i_baseline_actual=1.5, M_ca=0.2, beta=0.9,
            z_e=1.8, z_i=0.7, theta_t=0.5,
            Pi_e_expected=3.5, Pi_i_expected=2.0,  # Π̂ > Π for resolution seeking
            arousal_level=0.6
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=4.0, Pi_i_baseline_actual=2.0, M_ca=0.8, beta=1.2,
            z_e=1.5, z_i=0.8, theta_t=-0.2,
            Pi_e_expected=4.0, Pi_i_expected=2.0,
            arousal_level=0.7
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=5.0, Pi_i_baseline_actual=1.8, M_ca=0.4, beta=1.0,
            z_e=1.2, z_i=0.5, theta_t=-0.8,
            Pi_e_expected=5.0, Pi_i_expected=1.8,
            arousal_level=0.6
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=2.0, Pi_i_baseline_actual=2.5, M_ca=-0.4, beta=0.8,
            z_e=0.3, z_i=0.4, theta_t=0.8,
            Pi_e_expected=2.0, Pi_i_expected=2.5,
            arousal_level=0.4
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=7.0, Pi_i_baseline_actual=1.0, M_ca=0.3, beta=1.1,
            z_e=2.5, z_i=0.3, theta_t=-1.8,
            Pi_e_expected=7.0, Pi_i_expected=1.0,
            arousal_level=0.8
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=2.5, Pi_i_baseline_actual=2.0, M_ca=-0.2, beta=0.9,
            z_e=0.8, z_i=0.6, theta_t=0.3,
            Pi_e_expected=4.0, Pi_i_expected=2.5,  # Π̂ > Π (expectations exceeded reality)
            arousal_level=0.4, MDD_profile=True
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=2.0, Pi_i_baseline_actual=2.0, M_ca=0.5, beta=0.9,
            z_e=0.3, z_i=0.3, theta_t=0.5,
            Pi_e_expected=2.0, Pi_i_expected=2.0,
            arousal_level=0.4
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=4.5, Pi_i_baseline_actual=1.2, M_ca=-0.1, beta=0.8,
            z_e=1.0, z_i=0.3, theta_t=-0.6,
            Pi_e_expected=4.5, Pi_i_expected=1.2,
            arousal_level=0.6
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=1.5, Pi_i_baseline_actual=2.0, M_ca=0.3, beta=0.7,
            z_e=0.2, z_i=0.3, theta_t=1.2,
            Pi_e_expected=1.5, Pi_i_expected=2.0,
            arousal_level=0.3
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=2.5, Pi_i_baseline_actual=2.0, M_ca=0.0, beta=1.0,
            z_e=0.5, z_i=0.4, theta_t=0.0,
            Pi_e_expected=2.5, Pi_i_expected=2.0,
            arousal_level=0.5
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=5.0, Pi_i_baseline_actual=1.5, M_ca=0.2, beta=1.0,
            z_e=0.8, z_i=0.4, theta_t=-0.4,
            Pi_e_expected=5.0, Pi_i_expected=1.5,
            arousal_level=0.7
        )
        ...
        self._add_state(
            ...
            Pi_e_actual=2.0, Pi_i_baseline_actual=3.0, M_ca=0.6, beta=1.1,
            z_e=0.4, z_i=0.7, theta_t=0.8,
            Pi_e_expected=2.0, Pi_i_expected=3.0,
            arousal_level=0.4
        )
...
class MeasurementEquations:
    ...
    @staticmethod
    def compute_detection_threshold(theta_t: float, 
    ...
    @classmethod
    def compute_all_measurements(cls, state: PsychologicalState,
                                neuromodulators: Optional[Dict[str, float]] = None) -> Dict[str, float]:
...
class CompleteAPGIVisualizer:
    ...
    def plot_comprehensive_dashboard(self, history: Dict[str, np.ndarray]) -> plt.Figure:
        ...
        plt.suptitle("APGI SYSTEM DASHBOARD", 
    ...
    def _plot_core_dynamics(self, ax, history):
        ...
        if len(ignition_indices) > 0:
            ax.scatter(time[ignition_indices], S[ignition_indices], 
                      color='red', s=50, zorder=5, label='Ignitions', alpha=0.6)
    ...
    def _plot_measurements(self, ax, history):
        ...
        if 'P3b_latency' in history:
            ax_twin = ax.twinx()
            ax_twin.plot(time, history['P3b_latency'], 'purple', 
                        label='P3b Latency', alpha=0.7, linestyle=':')
    ...
    def _plot_neuromodulators(self, ax, history):
        ...
        for i, (neuromod, color, label) in enumerate(zip(neuromods, colors, labels)):
            if neuromod in history:
                ax.plot(time, history[neuromod], color=color, 
    ...
    def _plot_domain_analysis(self, ax, history):
        ...
        if 'content_domain' in history:
            ...
            time = history['time']
            ax.fill_between(time, 0, 1, where=domain_numeric>0.5,
                          color='red', alpha=0.2, label='Survival Content')
            ax.fill_between(time, 0, 1, where=domain_numeric<=0.5,
                          color='blue', alpha=0.2, label='Neutral Content')
            
            # Plot surprise
            ax.plot(time, history['S']/max(history['S']), 'k-', 
                   linewidth=1, alpha=0.7, label='Normalized Surprise')
    ...
    def _plot_psychiatric_profiles(self, ax):
        ...
        parameters = ['Pi_e_expected', 'Pi_i_expected', 'theta_t', 'beta', 
                     'precision_expectation_gap', 'arousal_level']
        ...
        for i, (profile, color) in enumerate(zip(profiles, colors)):
            try:
                ...
                ax.bar(x + (i-1)*width, values, width, 
                      label=profile, color=color, alpha=0.7)
    ...
    def _plot_state_space(self, ax, history):
        ...
        ax.plot(S_range, S_range, 'r--', linewidth=2, alpha=0.7, 
    ...
    def _plot_precision_gap(self, ax, history):
        ...
        if 'precision_expectation_gap' in history:
            ...
            if 'Pi_e_actual' in history and 'Pi_e_expected' in history:
                gap = (history['Pi_e_expected'] - history['Pi_e_actual'] +
                      history['Pi_i_expected'] - history['Pi_i_actual']) / 2
            else:
                gap = np.zeros_like(time)
        
        ax.plot(time, gap, 'r-', linewidth=2, alpha=0.8, label='Π̂ - Π Gap')
        ax.fill_between(time, 0, gap, where=gap>0, 
                       color='red', alpha=0.3, label='Anxiety Zone (Π̂ > Π)')
        ax.fill_between(time, 0, gap, where=gap<=0, 
                       color='blue', alpha=0.3, label='Normal Zone (Π̂ ≤ Π)')
...
def run_complete_demo():
    ...
    print(f"   • Anxiety: Π̂_e={anxiety_state.Pi_e_expected:.1f} vs Π_e={anxiety_state.Pi_e_actual:.1f}")
...
def verify_all_fixes():
    ...
    if hasattr(anxiety_state, 'Pi_e_expected') and hasattr(anxiety_state, 'Pi_e_actual'):
        ...
        print(f"   Anxiety: Π̂_e={anxiety_state.Pi_e_expected:.1f}, Π_e={anxiety_state.Pi_e_actual:.1f}")
