...
## APGI Falsification Protocols

| **ID** | **Paper** | **Protocol Name** | **Actual Repo Filename** |
| :--- | :--- | :--- | :--- |
| **FP-1** | Framework Paper | Active Inference Agents | `FP_01_ActiveInference.py` |
...
| :--- | :--- | :--- | :--- |
| **VP-1** | Paper Protocol 6 | Synthetic Neural Data / ML Classification | `VP_01_SyntheticEEG_MLClassification.py` |
| **VP-2** | Paper Protocol 6 | Behavioral Bayesian Comparison | `VP_02_Behavioral_BayesianComparison.py` |
| **VP-3** | Paper Protocol 3 | Agent Comparison (Active Inference) | `VP_03_ActiveInference_AgentSimulations.py` |
| **VP-4** | Epistemic P5–P8 (Level 2) | Phase Transition (Information-Theoretic) | `VP_04_PhaseTransition_EpistemicLevel2.py` |
| **VP-5** | Evolutionary Plausibility | Evolutionary Emergence / Analytical Validation | `VP_05_EvolutionaryEmergence.py` |
| **VP-6** | Liquid Network Substrate | Neural Network Inductive Bias | `VP_06_LiquidNetwork_InductiveBias.py` |
| **VP-7** | Paper Protocol 2 | TMS Causal Interventions | `VP_07_TMS_CausalInterventions.py` |
| **VP-8** | Paper Protocol 1 | Psychophysical Threshold Estimation | `VP_08_Psychophysical_ThresholdEstimation.py` |
| **VP-9** | Roadmap Priority 1 | Neural Signatures / Empirical Priority 1 | `VP_09_NeuralSignatures_EmpiricalPriority1.py` |
| **VP-10** | Roadmap Priority 2 | Causal Manipulations / Empirical Priority 2 | `VP_10_CausalManipulations_Priority2.py` |
| **VP-11** | Roadmap Priority 3 | MCMC / Cultural Neuroscience | `VP_11_MCMC_CulturalNeuroscience_Priority3.py` |
| **VP-12** | Paper Protocol 4 | Clinical Cross-Species / DoC Validation | `VP_12_Clinical_CrossSpecies_Convergence.py` |
| **VP-13** | Paper 4: Self-Audit | Epistemic Architecture Validation | `VP_13_Epistemic_Architecture.py` |
| **VP-14** | Paper Protocol 5 | fMRI Anticipation vs. Experience | `VP_14_fMRI_Anticipation_Experience.py` |
