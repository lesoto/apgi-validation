...
| 8 | VP_08_Psychophysical_ThresholdEstimation.py | Validation | VP-8 ✓ Paper Protocol 1 | Psychophysical Threshold Estimation | 77% |
...
| 13 | VP_13_Epistemic_Architecture.py | Validation | VP-13 NEW | Epistemic Architecture Predictions (P5–P12) | 74% |
| 14 | VP_14_fMRI_Anticipation_Experience.py | Validation | VP-14 NEW — Implemented | fMRI BOLD Simulation (Anticipation/Experience) | 70% |
| 15 | VP_15_fMRI_Anticipation_vmPFC.py | Validation | VP-15 NEW — STUB | fMRI vmPFC Anticipation (awaiting real data) | 5% |
...
| 19 | __init__.py | Validation | — | Python package marker | — |
...
| 28 | FP_09_NeuralSignatures_P3b_HEP.py | Falsification | FP-9 | Neural Signatures — EEG / P3b / HEP | 62% |
...
| 31 | FP_12_CrossSpeciesScaling.py | Falsification | FP-12 (scaling sub-protocol) | Cross-Species Allometric Scaling (P12) | 55% |
| **Falsification Files — Orchestrators & Infrastructure** | | | | | |
| 32 | FP_ALL_Aggregator.py | Falsification | FP-12 (aggregator logic) | Terminal framework falsification (Conditions A & B) | Active |
...
| 35 | __init__.py | Falsification | — | Python package marker | — |
...
| --- | --------- | ------- | ----------- |
| 1 | `FP_12_Falsification_Aggregator.py` | FP-12 | Framework-level aggregator |
...
| 14 | `FP_12_CrossSpeciesScaling.py` | FP-10 (cross-species) | Allometric scaling |
...
| 18 | `FP_11_FP_11_Falsification_LiquidNetworkDynamics_EchoState.py` | FP-11 / FP-12 | Echo-state / liquid network |
...
## 2. Protocol Cross-Reference by Paper

Full cross-reference of all FP (Falsification Protocol) and VP (Validation Protocol) assignments across the four-paper APGI series. Compiled from source code audit of all 14 protocol files (FP_01–FP_12, FP-10 Dispatcher, FP_ALL_Aggregator).
...
- **Terminal** = Protocol is the framework-level aggregator
...
**Paper 4 (Epistemic Architecture) note:** Paper 4's seven Methodological Standards (Std 1–7) and three-tier epistemic levels (Level 1 thermodynamic, Level 2 information-theoretic, Level 3 computational) provide the primary organizational framework for how protocols are classified. Level and Std labels in the tables reflect these Paper 4 categories.

---

## Validation Protocol 1 — Synthetic Neural Data Generation & ML Classification VP_1_SyntheticEEG_MLClassification.py
...
## Validation Protocol 2 — Behavioral Validation (VP_2_Validation_Protocol_2.py)
...
## Validation Protocol 3 — Agent Comparison Experiment (VP_3_ActiveInference_AgentSimulations_Protocol3.py)
...
## Validation Protocol 4 — Phase Transition Analysis (VP_4_InformationTheoretic_PhaseTransition_Level2.py)
...
## Validation Protocol 5 — Evolutionary Emergence (VP_5_EvolutionaryEmergence_AnalyticalValidation.py)
...
## Validation Protocol 6 — Network Comparison (VP_6_NeuralNetwork_InductiveBias_ComputationalBenchmark.py)
...
## Validation Protocol 8 — Parameter Sensitivity (VP_8_Psychophysical_ThresholdEstimation_Protocol1.py)
...
## Validation Protocol 9 — Neural Signatures Validation (VP_9_ConvergentNeuralSignatures_Priority1_EmpiricalRoadmap.py)
...
## Validation Protocol 10 — Cross-Species Scaling / Causal Manipulations (CausalManipulations_VP_7_TMS_Pharmacological_CausalIntervention_Protocol2.py)
...
Cultural neuroscience motivation documented in lines 6-32 of VP_11_Validation_Protocol_11.py, mapping to APGI parameters {θ₀, Πⁱ, β, α} with quantitative predictions from APGI-MULTI-SCALE-CONSCIOUSNESS-Paper.
...
## Validation Protocol 12 — Liquid Network / Clinical-Cross-Species (VP_12_Clinical_CrossSpecies_Convergence_Protocol4.py)

Framework-Level Aggregator (FP_12_Falsification_Aggregator.py) has complete implementation:
...
FP_1_FP_1_Falsification_ActiveInferenceAgents_F1F2.py
...
### Falsification Protocol 2 — Agent Comparison / Convergence Benchmark (FP_2_FP_2_Falsification_AgentComparison_ConvergenceBenchmark.py)
...
Framework-level criteria (conditions a and b, the 14 named predictions) live in FP_12_Falsification_Aggregator.py.
Naming/routing collision fixed: Protocol 3 path corrected to "../Validation/VP_3_ActiveInference_AgentSimulations_Protocol3.py".
...
#### Falsification Protocol 12 — Framework-Level Aggregator (FP_12_Falsification_Aggregator.py)
...
### Falsification Files (22 total)
 ...
 | 14  `FP_12_CrossSpeciesScaling.py`  FP-10 (cross-species)  Allometric scaling  55%  |
...
- `FP_12_CrossSpeciesScaling.py` — allometric scaling
...
**Protocol-to-file mapping in GUI (ground truth for protocol numbering):**
 ...
 | Protocol 10: Cross-Species Scaling  `FP_12_CrossSpeciesScaling.py`
...
All 12 falsification protocols work identically: the GUI maps directly to full implementation files without intermediate wrappers. The mapping is consistent across Protocols 1–12.
 ...
 | FP-10  Protocol 10: Cross-Species Scaling  `FP_12_CrossSpeciesScaling.py`  Allometric scaling
...
### 8.1 Missing implementation
 ...
 | **FP-10 split across two files**  `FP_10_FP_10_Falsification_BayesianEstimation_MCMC.py` and `FP_12_CrossSpeciesScaling.py` both claim FP-10. GUI maps Protocol 10 only to `FP_12_CrossSpeciesScaling.py`.  MEDIUM
...
| # | Filename | Paper | Validation Protocol |
| --- | ---------- | ------- | ------------------- |
| 1 | `VP_3_ActiveInference_AgentSimulations_Protocol3.py` | APGI Framework Paper | VP-3 · Agent Comparison Experiment |
| 2 | `BayesianModelComparison_ParameterRecovery.py` | APGI Framework Paper | VP-1 (support) · Synthetic Neural Data / ML Classification |
| 3 | `VP_10_Falsification_CausalManipulations_TMS_Pharmacological_Priority2.py` | APGI Epistemic Architecture Paper | VP-10 · Causal Manipulations (Roadmap Priority 2) |
| 4 | `VP_12_Clinical_CrossSpecies_Convergence_Protocol4.py` | APGI Liquid Networks Paper / Multi-Scale Consciousness Paper | VP-12 · Clinical Cross-Species Convergence (Roadmap Priority 4) |
| 5 | `VP_9_ConvergentNeuralSignatures_Priority1_EmpiricalRoadmap.py` | APGI Epistemic Architecture Paper | VP-9 · Convergent Neural Signatures (Roadmap Priority 1) |
| 6 | `VP_5_EvolutionaryEmergence_AnalyticalValidation.py` | APGI Multi-Scale Consciousness Paper | VP-5 · Evolutionary Emergence *(Paper Protocol 5 fMRI MISSING)* |
| 7 | `VP_4_InformationTheoretic_PhaseTransition_Level2.py` | APGI Epistemic Architecture Paper | VP-4 · Phase Transition Analysis (Level 2, P5–P8) |
| 8 | `Master_Validation.py` | All Papers | — Orchestrator (not a protocol) |
| 9 | `VP_6_NeuralNetwork_InductiveBias_ComputationalBenchmark.py` | APGI Liquid Networks Paper | VP-6 · Network Comparison |
| 10 | `VP_8_Psychophysical_ThresholdEstimation_Protocol1.py` | APGI Framework Paper | VP-8 · Psychophysical Threshold Estimation (Paper Protocol 1) |
| 11 | `VP_11_QuantitativeModelFits_SpikingLNN_Priority3.py` | APGI Multi-Scale Consciousness Paper | VP-11 (support) · Quantitative Model Fits / Spiking LNN (Roadmap Priority 3) |
| 12 | `VP_1_SyntheticEEG_MLClassification.py` | APGI Framework Paper | VP-1 · Synthetic Neural Data / ML Classification (Paper Protocol 6 partial) |
| 13 | `VP_7_TMS_Pharmacological_CausalIntervention_Protocol2.py` | APGI Framework Paper / Epistemic Architecture Paper | VP-7 · TMS Pharmacological Causal Interventions (Paper Protocol 2) |
| 14 | `VP_2_Validation_Protocol_2.py` | APGI Framework Paper | VP-2 · Behavioral Validation (Paper Protocol 6 partial) |
| 15 | `VP_11_Validation_Protocol_11.py` | APGI Multi-Scale Consciousness Paper | VP-11 · Cultural Neuroscience / Bayesian Estimation (Roadmap Priority 3) |
| 16 | `Validation_Protocol_P4_Epistemic.py` | APGI Epistemic Architecture Paper | VP-4 (support) · Epistemic Architecture Predictions (P5–P12) |

---

## Falsification Files

| # | Filename | Paper | Falsification Protocol |
| --- | ---------- | ------- | ---------------------- |
...
| 13 | `FP_10_FP_10_Falsification_BayesianEstimation_ParameterRecovery.py` | APGI Multi-Scale Consciousness Paper | FP-11 · Bayesian Estimation Parameter Recovery |
| 14 | `FP_12_CrossSpeciesScaling.py` | APGI Multi-Scale Consciousness Paper | FP-10 (cross-species arm) · Cross-Species Allometric Scaling (P12) |
| 15 | `FP_5_FP_5_Falsification_EvolutionaryPlausibility_Standard6.py` | APGI Multi-Scale Consciousness Paper | FP-5 (full) · Evolutionary Plausibility |
| 16 | `FP_3_FP_3_Falsification_FrameworkLevel_MultiProtocol.py` | APGI Framework Paper | FP-3 (full) · Framework-Level Multi-Protocol Synthesis |
| 17 | `FP_4_FP_4_Falsification_InformationTheoretic_PhaseTransition.py` | APGI Epistemic Architecture Paper | FP-4 (full) · Information-Theoretic Phase Transition |
| 18 | `FP_11_FP_11_Falsification_LiquidNetworkDynamics_EchoState.py` | APGI Liquid Networks Paper | FP-11 / FP-12 · Liquid Network Dynamics / Echo-State Network |
| 19 | `FP_7_Falsification_MathematicalConsistency_Equations.py` | APGI Framework Paper | FP-7 · Mathematical Consistency (4 Canonical APGI Equations) |
| 20 | `FP_6_FP_6_Falsification_NeuralNetwork_EnergyBenchmark.py` | APGI Liquid Networks Paper | FP-6 (full) · Neural Network Energy Benchmark |
| 21 | `FP_9_FP_9_Falsification_NeuralSignatures_EEG_P3b_HEP.py` | APGI Epistemic Architecture Paper | FP-9 · Neural Signatures EEG / P3b / HEP |
| 22 | `FP_8_FP_8_Falsification_ParameterSensitivity_Identifiability.py` | APGI Framework Paper | FP-8 · Parameter Sensitivity & Identifiability |
