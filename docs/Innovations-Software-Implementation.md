...
APGI-Full-Dynamic-Model.py, `APGIFullDynamicModel.threshold_dynamics()`  
...
APGI-Entropy-Implementation.py, MultiLevelEntropyModule (via APGILiquidNetwork)  
...
APGI-Multimodal-Integration.py, `APGINormalizer` class
...
Validation/ directory protocols (Validation-Protocol-1.py through Validation-Protocol-12.py)  
...
APGI-Full-Dynamic-Model.py, threshold dynamics
...
APGI-Full-Dynamic-Model.py and APGI-Psychological-States.py, threshold dynamics and parameter profiles  
...
APGI-Multimodal-Integration.py and Validation/ protocols  
...
Validation/ directory (Validation-Protocol-1.py through Validation-Protocol-12.py)  
...
Validation/APGI-Validation-GUI.py and Validation-Protocol-*.py  
