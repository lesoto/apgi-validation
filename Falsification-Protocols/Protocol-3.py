        ...
        for env_name in results.keys():
            ...
            for agent in results[env_name].keys():
                ...
                if 'convergence_trials' in results[env_name][agent]:
                    analysis['P3a'][env_name][agent] = results[env_name][agent]['convergence_trials']
                else:
        ...
        for env_name in results.keys():
            ...
            for agent in results[env_name].keys():
                if 'cumulative_rewards' in results[env_name][agent]:
                    analysis['cumulative_rewards'][env_name][agent] = results[env_name][agent]['cumulative_rewards']
                else:
