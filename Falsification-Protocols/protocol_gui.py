...
class ProtocolRunnerGUI:
    ...
    def setup_ui(self):
        ...
        # Title
        title_label = ttk.Label(main_frame, text="APGI Falsification Protocols", 
                               font=('Arial', 16, 'bold'))
        ...
        for i, (protocol_name, protocol_info) in enumerate(self.protocols.items()):
            ...
            btn = ttk.Button(button_frame, text=protocol_name.split(': ')[1], 
        ...
        clear_btn = ttk.Button(main_frame, text="Clear Console", 
                ...
                if protocol_info['class'] == 'NetworkComparisonExperiment':
                    ...
                    try:
                        ...
                        if "broadcast" in str(ve):
                            self.log_message("Broadcasting error in Protocol-3 - this is expected due to observation size mismatches")
                    ...
                    for trial in range(5):
                        ...
                        total_reward += reward
                        self.log_message(f"Trial {trial+1}: Action={action}, Reward={reward:.2f}, "
