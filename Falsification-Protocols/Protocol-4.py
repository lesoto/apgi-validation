...
class InformationTheoreticAnalysis:
    ...
    def compute_transfer_entropy(self, history: Dict, 
    ...
    def compute_integrated_information(self, history: Dict,
    ...
    def detect_phase_transition(self, history: Dict) -> Dict:
        ...
        if np.sum(near_threshold) > 10 and np.sum(far_from_threshold) > 10:
            ...
            results['susceptibility_ratio'] = susceptibility_near / (susceptibility_far + 1e-10)
    ...
    def run_phase_transition_analysis(self, n_simulations: int = 100) -> Dict:
        ...
        for _ in range(n_simulations):
            ...
            if len(ignition_indices) > 0:
                # Φ at ignition
                ignition_phi = [phi[max(0, idx-50)] for idx in ignition_indices 
