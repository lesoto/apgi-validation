...
class APGIMasterValidator:
        ...
        for protocol_num in range(1, 9):
            try:
                ...
                if hasattr(protocol_module, 'run_validation'):
                    ...
                    validation_functions = [attr for attr in dir(protocol_module) 
    ...
    def apply_decision_tree(self) -> str:
        ...
        secondary_failures = len([r for r in self.falsification_status['secondary'] if not r['passed']])
        tertiary_failures = len([r for r in self.falsification_status['tertiary'] if not r['passed']])
