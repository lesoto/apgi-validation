    ...
    def test_formal_model_loading(self):
        ...
        try:
            ...
            if formal_model_path.exists():
                ...
                spec = importlib.util.spec_from_file_location('formal_model', formal_model_path)
    ...
    def test_parameter_estimation_loading(self):
        ...
        try:
            ...
            if param_est_path.exists():
                import importlib.util
                spec = importlib.util.spec_from_file_location('parameter_estimation', param_est_path)
                module = importlib.util.module_from_spec(spec)
                spec.loader.exec_module(module)
