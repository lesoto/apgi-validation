...
"""
    ...
    def test_file_permission_denied(self, temp_dir):
        ...
        if platform.system() == "Windows":
            # On Windows, chmod doesn't prevent reading the same way as Unix
            # Skip the test since Windows file permissions work differently
            pytest.skip("File permission testing not supported on Windows")
