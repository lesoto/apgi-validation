...
def conduct_prior_predictive_checks(n_samples: int = 1000, save_plots: bool = True):
    ...
    if save_plots:
        ...
        for idx, (param, (low, high, ref)) in enumerate(checks.items()):
            ...
            axes[idx].axvline(low, color="red", linestyle="--", label=f"Empirical range")
...
def main():
    ...
    print("-" * 80)
    prior_valid = conduct_prior_predictive_checks(n_samples=1000, save_plots=True)
    ...
    # Step 7: Test-retest reliability (Session 2)
    ...
    # Step 8: Predictive validity on independent datasets
    ...
    try:
        results_summary = {
            ...
            "model_diagnostics": {
                ...
                "n_divergences": (int(n_divergences) if "n_divergences" in locals() else 0),
            },
            "thresholds": {
