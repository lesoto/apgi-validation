...
if __name__ == "__main__":
    ...
    # Save results
    with open("APGI-Computational-Benchmarking-Enhanced-Results.json", "w") as f:
        json.dump(final_results, f, indent=2, default=str)

    logger.info(
        "Enhanced benchmarking complete. Results saved to APGI-Computational-Benchmarking-Enhanced-Results.json"
    )
