...
def _get_protocol1():
    ...
    try:
        ...
        protocol1_path = os.path.abspath(
            os.path.join(
                os.path.dirname(__file__), "Falsification-ActiveInferenceAgents-F1F2.py"
            )
        )
...
class AgentComparisonExperiment:
    ...
    def run_full_experiment(self) -> Dict[str, Any]:
        ...
        # Note: Protocol 3 is the agent comparison protocol (ActiveInference-AgentSimulations-Protocol3.py)
        # which produces P3.conv and P3.bic predictions
        protocol_files = {
            1: "Falsification-ActiveInferenceAgents-F1F2.py",
            2: "Falsification-AgentComparison-ConvergenceBenchmark.py",
            3: "../Validation/ActiveInference-AgentSimulations-Protocol3.py",
...
def check_framework_falsification_conditions(
    ...
    """
    Apply framework-level falsification conditions (a) and (b) using APGI-Falsification-Aggregator.
