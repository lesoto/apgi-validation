    ...
    def __init__(self, root):
        ...
        self.protocols = {
            "Protocol 1: APGI Agent": {
                "file": "Falsification_ActiveInferenceAgents_F1F2.py",
            ...
            "Protocol 3: Agent Comparison": {
                "file": "Falsification_FrameworkLevel_MultiProtocol.py",
            ...
            "Protocol 5: Evolutionary": {
                "file": "Falsification_EvolutionaryPlausibility_Standard6.py",
            ...
            "Protocol 12: Liquid Network Dynamics": {
                "file": "Falsification_LiquidNetworkDynamics_EchoState.py",
