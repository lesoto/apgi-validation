...
from .constants import (DIM_CONSTANTS, MODEL_PARAMS, NEURAL_DEFAULTS,
                        PARAMETER_BOUNDS, PCI_NORMALIZATION, SPECIES_METRICS,
                        SYSTEM_DEFAULTS)
...
from .falsification_thresholds import (  # Validation Protocol 12 constants
    F1_1_ALPHA, F1_1_MIN_ADVANTAGE_PCT, F1_1_MIN_COHENS_D, F1_5_COHENS_D_MIN,
    F1_5_PAC_INCREASE_MIN, F1_5_PAC_MI_MIN, F1_5_PERMUTATION_ALPHA, F2_1_ALPHA,
    F2_1_MIN_ADVANTAGE_PCT, F2_1_MIN_COHENS_H, F2_1_MIN_PP_DIFF, F2_2_ALPHA,
    F2_2_MIN_CORR, F2_2_MIN_FISHER_Z, F2_3_ALPHA, F2_3_MIN_BETA, F2_3_MIN_R2,
    F2_3_MIN_RT_ADVANTAGE_MS, F2_3_MIN_STANDARDIZED_BETA, F2_4_ALPHA,
    F2_4_MIN_BETA_INTERACTION, F2_4_MIN_CONFIDENCE_EFFECT_PCT, F5_1_MIN_ALPHA,
    F5_1_MIN_COHENS_D, F5_1_MIN_PROPORTION, F5_2_MIN_CORRELATION,
    F5_2_MIN_PROPORTION, F5_3_FALSIFICATION_RATIO, F5_3_MIN_COHENS_D,
    F5_3_MIN_GAIN_RATIO, F5_3_MIN_PROPORTION, F5_4_MIN_PEAK_SEPARATION,
    F5_4_MIN_PROPORTION, F5_5_MIN_LOADING, F5_5_PCA_MIN_VARIANCE, F5_6_ALPHA,
    F5_6_MIN_COHENS_D, F5_6_MIN_PERFORMANCE_DIFF_PCT, F6_1_CLIFFS_DELTA_MIN,
    F6_1_LTCN_MAX_TRANSITION_MS, F6_1_MANN_WHITNEY_ALPHA,
    F6_2_LTCN_MIN_WINDOW_MS, F6_2_MIN_CURVE_FIT_R2, F6_2_MIN_INTEGRATION_RATIO,
    F6_2_MIN_R2, F6_2_WILCOXON_ALPHA, F6_5_HYSTERESIS_MAX, F6_5_HYSTERESIS_MIN,
    V12_1_ALPHA, V12_1_MIN_COHENS_D, V12_1_MIN_ETA_SQUARED,
    V12_1_MIN_IGNITION_REDUCTION_PCT, V12_1_MIN_P3B_REDUCTION_PCT, V12_2_ALPHA,
    V12_2_FALSIFICATION_CORR, V12_2_FALSIFICATION_PILLAIS,
    V12_2_MIN_CORRELATION, V12_2_MIN_PILLAIS_TRACE)
