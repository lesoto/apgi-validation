...
PROTOCOL_DEPENDENCIES = {
    ...
    "FP_02_AgentComparisonConvergenceBenchmark": ["FP_01_ActiveInference"],
    "FP_03_FrameworkLevelMultiProtocol": [
        "FP_01_ActiveInference",
        "FP_02_AgentComparisonConvergenceBenchmark",
    ],
    "FP_04_PhaseTransitionEpistemicArchitecture": ["FP_03_FrameworkLevelMultiProtocol"],
    ...
    "FP_11_LiquidNetworkDynamicsEchoState": ["FP_06_LiquidNetworkEnergyBenchmark"],
    "FP_12_CrossSpeciesScaling": [],
    # VP protocols
    "VP_01_SyntheticEEGMLClassification": [],
    "VP_02_BehavioralBayesianComparison": [],
    "VP_03_ActiveInferenceAgentSimulations": ["FP_01_ActiveInference"],
    "VP_04_PhaseTransitionEpistemicLevel2": ["FP_04_PhaseTransitionEpistemicArchitecture"],
    "VP_05_EvolutionaryEmergence": ["FP_05_EvolutionaryPlausibility"],
    "VP_06_LiquidNetworkInductiveBias": ["FP_06_LiquidNetworkEnergyBenchmark"],
    "VP_07_TMSCausalInterventions": [],
    "VP_08_PsychophysicalThresholdEstimation": [],
    "VP_09_NeuralSignaturesEmpiricalPriority1": ["FP_09_NeuralSignaturesP3bHEP"],
    "VP_10_CausalManipulationsPriority2": [],
    "VP_11_MCMCCulturalNeurosciencePriority3": [],
    "VP_12_ClinicalCrossSpeciesConvergence": ["FP_12_CrossSpeciesScaling"],
    "VP_13_EpistemicArchitecture": ["FP_04_PhaseTransitionEpistemicArchitecture"],
    "VP_14_FMRIAnticipationExperience": [],
    "VP_15_FMRIAnticipationVmPFC": ["FP_05_EvolutionaryPlausibility"],
}

# Prediction IDs for each protocol
PROTOCOL_PREDICTIONS = {
    "FP_01_ActiveInference": ["P1.1", "P1.2", "P1.3"],
    "FP_02_AgentComparisonConvergenceBenchmark": ["P2.a", "P2.b"],
    "FP_03_FrameworkLevelMultiProtocol": [
        "P3.1",
        "P3.2",
        "P3.3",
    ...
    "FP_04_PhaseTransitionEpistemicArchitecture": ["P3.a", "P3.b", "P3.c", "P3.d"],
    "FP_05_EvolutionaryPlausibility": ["P5.a", "P5.b"],
    "FP_06_LiquidNetworkEnergyBenchmark": ["F1.1", "F1.2", "F1.3"],
    "FP_07_MathematicalConsistency": ["P7.1", "P7.2", "P7.3"],
    "FP_08_ParameterSensitivityIdentifiability": ["P8.1", "P8.2", "P8.3", "P8.4"],
    "FP_09_NeuralSignaturesP3bHEP": ["P4.a", "P4.b", "P4.c", "P4.d"],
    "FP_10_BayesianEstimationMCMC": ["fp10a", "fp10b", "fp10c", "fp10b_scaling"],
    "FP_11_LiquidNetworkDynamicsEchoState": ["F3.1", "F3.2", "F3.3"],
    "FP_12_CrossSpeciesScaling": ["F4.1", "F4.2", "F4.3"],
    "VP_01_SyntheticEEGMLClassification": ["V1.1", "V1.2", "V1.3"],
    "VP_02_BehavioralBayesianComparison": ["V2.1", "V2.2"],
    "VP_03_ActiveInferenceAgentSimulations": ["V3.1", "V3.2", "V3.3"],
    "VP_04_PhaseTransitionEpistemicLevel2": ["V4.1", "V4.2"],
    "VP_05_EvolutionaryEmergence": ["V5.1", "V5.2"],
    "VP_06_LiquidNetworkInductiveBias": ["V6.1", "V6.2", "V6.3"],
    "VP_07_TMSCausalInterventions": ["V7.1", "V7.2"],
    "VP_08_PsychophysicalThresholdEstimation": ["V8.1", "V8.2"],
    "VP_09_NeuralSignaturesEmpiricalPriority1": ["V9.1", "V9.2"],
    "VP_10_CausalManipulationsPriority2": ["V10.1", "V10.2"],
    "VP_11_MCMCCulturalNeurosciencePriority3": ["V11.1", "V11.2", "V11.3"],
    "VP_12_ClinicalCrossSpeciesConvergence": ["V12.1", "V12.2"],
    "VP_13_EpistemicArchitecture": ["V13.1", "V13.2"],
    "VP_14_FMRIAnticipationExperience": ["V14.1", "V14.2"],
    "VP_15_FMRIAnticipationVmPFC": ["V15.1", "V15.2", "V15.3"],
}
