...
def _initialize_registry():
    ...
    PROTOCOL_REGISTRY.register_protocol(
        ProtocolInfo(
            ...
            aliases=["P1", "F1", "F2", "ActiveInferenceAgents",
    ...
    PROTOCOL_REGISTRY.register_protocol(
        ProtocolInfo(
            ...
            priority_level="P2",
            category="Falsification",
            aliases=["P2", "AgentComparison", "ConvergenceBenchmark", "IGT",
                     "IowaGamblingTask", "F2-Iowa",
    ...
    PROTOCOL_REGISTRY.register_protocol(
        ProtocolInfo(
            ...
            category="Falsification",
            aliases=["FrameworkLevel", "MultiProtocol", "Framework", "Integration",
    ...
    PROTOCOL_REGISTRY.register_protocol(
        ProtocolInfo(
            ...
            priority_level="F4",
            category="Falsification",
            aliases=["F4", "PhaseTransition", "Bistability", "CriticalSlowing",
    ...
    PROTOCOL_REGISTRY.register_protocol(
        ProtocolInfo(
            ...
            category="Falsification",
            aliases=["Standard6", "Evolutionary", "EvoPlausibility",
    ...
    PROTOCOL_REGISTRY.register_protocol(
        ProtocolInfo(
            ...
            priority_level="Validation",
            category="Falsification",
            aliases=["MathematicalConsistency", "Equations", "MathConsistency",
    ...
    PROTOCOL_REGISTRY.register_protocol(
        ProtocolInfo(
            ...
            category="Falsification",
            aliases=["ParameterSensitivity", "Sensitivity", "Identifiability",
                     "ParamAnalysis", "FP_08_ParameterSensitivity_Identifiability"],
        )
    )
    ...
    PROTOCOL_REGISTRY.register_protocol(
        ProtocolInfo(
            ...
            priority_level="Validation",
            category="Falsification",
            aliases=["NeuralSignatures-EEG", "EEG", "P3b", "HEP",
                     "NeuralSignatures", "FP_09_NeuralSignatures_P3b_HEP"],
        )
    )
    ...
    PROTOCOL_REGISTRY.register_protocol(
        ProtocolInfo(
            ...
            aliases=["BayesianEstimation-MCMC", "MCMC", "BayesianMCMC", "FP10",
    ...
    PROTOCOL_REGISTRY.register_protocol(
        ProtocolInfo(
            ...
            priority_level="Advanced",
            category="Falsification",
            aliases=["LiquidNetworkDynamics", "LiquidNetwork", "EchoState", "LTC",
    ...
    PROTOCOL_REGISTRY.register_protocol(
        ProtocolInfo(
            ...
            priority_level="P12",
            category="Falsification",
            aliases=["P12", "CrossSpecies", "Scaling",
    ...
    # ------------------------------------------------------------------
    _vp_entries = [
        ("VP-01", "VP_01_SyntheticEEG_MLClassification.py",
        ...
        ("VP-10", "VP_10_CausalManipulations_Priority2.py",
        ...
        ("VP-21", "VP_21_FreeEnergy_PredictionError.py",
