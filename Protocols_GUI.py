...
class APGIValidationGUI:
    ...
    def create_widgets(self) -> None:
        ...
        # Populate protocol list with BooleanVar tracking — canonical APGI-P00–P07 only
        protocols_info = {
            0: "APGI-P00: HEP Proxy Validation",
            1: "APGI-P01: Cardiac EEG (EEG Interoceptive Gating)",
            2: "APGI-P02: Somatic Agent Simulation (Active Inference)",
            3: "APGI-P03: fMRI Anticipation (vmPFC)",
            4: "APGI-P04: Metabolic Crossover",
            5: "APGI-P05: Causal TMS & Neuromodulation",
            6: "APGI-P06: Ignition Dynamics (iEEG)",
            7: "APGI-P07: DOC Biomarker",
        }
        self.protocol_vars = {}
    ...
    def run_validation(self) -> None:
        ...
        try:
            ...
            # Validate protocol numbers — only canonical APGI-P00–P07 (keys 0–7).
            for protocol_num in selected_protocols:
                if not isinstance(protocol_num, int) or protocol_num < 0 or protocol_num > 7:
                    messagebox.showerror(
                        "Error",
                        f"Invalid protocol number: {protocol_num}. Must be between 0 and 7.",
                    )
                    return
...
Interpretation:
    ...
    def _execute_single_protocol(
        ...
        try:
            ...
            # Protocol file mapping — canonical APGI-P00 through APGI-P07.
            protocol_file_map = {
                0: "VP_00_HEPProxyValidation.py",           # APGI-P00
                1: "VP_01_SyntheticEEGMLClassification.py", # APGI-P01
                2: "VP_03_ActiveInferenceAgentSimulations.py", # APGI-P02
                3: "VP_14_FMRIAnticipationExperience.py",   # APGI-P03
                4: "VP_16_MetabolicATPGroundTruth.py",      # APGI-P04
                5: "VP_07_TMSCausalInterventions.py",       # APGI-P05
                6: "VP_20_EmpiricalIEEG.py",                # APGI-P06
                7: "VP_13_EpistemicArchitecture.py",        # APGI-P07
            }
    ...
    def _store_protocol_result(self, protocol_num: int, result: Dict, protocol_tiers: Dict, passed: bool) -> None:
        ...
        tier = protocol_tiers.get(protocol_num, "primary")
